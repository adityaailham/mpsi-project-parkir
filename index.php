...
<body class="bg-teal" style="overflow-y: hidden;">
  	<div class="panel container col-lg-4 col-md-6 col-sm-6 col-xs-12" style="position: relative; margin: auto; box-shadow: 0 7px 16px #00655b, 0 4px 5px #006f64;">
          ...
          <div class="panel-heading bg-teal">
              <h4 style="color: white" class="animated zoomIn">Login User</h4>
          </div>
          <div class="col-md-12 panel-body" style="padding-bottom:400px;">
                        <div class="col-md-11">
                          <form class="cmxform" method="POST">
                              ...
                              <form class="cmxform" method="POST">
                              <input class="submit btn btn-primary col-md-5 col-sm-5 col-xs-12" style="margin-top: 10px; margin-left: 10px;height: 40px;" type="submit" value="Sign Up" name="daftar">
                              </form>
                              <form class="cmxform" method="POST">
                              <input class="submit btn btn-danger col-md-5 col-sm-5 col-xs-12" style="margin-top: 75px; margin-left: 170px; height: 40px;" type="submit" value="Admin" name="signup">
                              </form>
                          </div>                       
          </div>
      </div>
