          ...
          <div class="col-md-12 nav-wrapper">
            <div class="navbar-header" style="width:100%;">
                ...
                <ul class="nav navbar-nav search-nav" style="margin-left: 7%">
                  ...
                  <li class="active"><a style="font-size: 18pt">Daftar Kendaraan</a></span></li>
                  <li><a href="lapor_admin.php" style="font-size: 18pt">Laporan Kehilangan</a></li>
              </ul>
      ...
      <div id="content">
        ...
        <!-- Daftar Kendaraan Yang Parkir -->          
               <div class="col-md-6 col-sm-12 col-xs-12" style="margin-top: 10px;">
                  <div class="col-md-12 panel">
                    <div class="col-md-12 panel-heading bg-dark-red">
                      <h4 style="color: white;font-size: 20pt;">Daftar Kendaraan <span class="right" style="color : #ffff; font-weight: bold; text-align: right; padding-right: 10px;">Terisi : <?= $cek_isi ?></span></h4>
                    </div>
