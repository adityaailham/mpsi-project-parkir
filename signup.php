...
<?php 
  ...
  if (isset($_POST['signup'])) {
    ...
    if ($row['username'] == $username){
      echo "<script>alert('Username Sudah Digunakan');document.location.href='signup.php'</script>";
    }
    else
...
<body style="overflow-y: hidden;" class="bg-blue">
	<div class="panel container col-lg-4 col-md-6 col-sm-8 col-xs-12" style="position: relative; margin: auto; box-shadow: 0 7px 16px #691816, 0 4px 5px #;">
